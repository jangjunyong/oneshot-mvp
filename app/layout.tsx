...
// 굵기는 400/500/600 이다 — 600 은 2026-09-20 도면 v3(GitHub 결)에서 헤딩용으로 더했다.
// Archivo 는 아무 규칙도 안 읽어 뺐다.
...
export const metadata: Metadata = {
  ...
  description:
    "축제 기획안의 예상 방문객을 공사 KT 일별 실측과 같은 기준으로 재서 통과·주의·과대·상한 초과를 찍고 내년 배수 구간을 낸다. 닮은 과거 축제 619건은 보조 근거.",
};
