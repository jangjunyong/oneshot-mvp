...
export const DEMOS: Record<DemoKey, Demo> = {
  gunpo: {
    ...
    query: GUNPO_2027,
    banner:
      "군포철쭉축제 2027 기획안입니다. 예상 방문객은 군포시가 공개한 2026년 목표 60만 명(경인일보 2026-04-17)을 기간 총계·연인원으로 읽어 옮겼고, 이력은 2024·2025·2026 세 해입니다. 예산 10억은 공개 수치가 없어 가정값입니다. 아래 칸을 고쳐 다른 축제를 넣을 수 있습니다.",
  ...
  hwacheon: {
    ...
    query: HWACHEON_2027,
    banner:
      "화천산천어축제 2027 기획안입니다(문체부 2026~2027 글로벌축제). 예상 방문객은 2025년 발표 실적 186만 명(경향신문 2025-02-02)을 기간 총계·연인원으로 그대로 옮긴 값이고, 이력은 2024·2025·2026 세 해입니다. 예산은 공개 수치를 못 찾아 비웠습니다.",
